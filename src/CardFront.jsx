...
const CardFront = ({ formData }) => {
  return (
    <div className="absolute top-14 left-24 card-container">
      <div className="absolute left-10 top-10 w-12 h-12 rounded-full bg-white large-circle"></div>
      <div className="absolute left-24 top-10 w-6 h-6 rounded-full border border-white transparent-circle"></div>
